    ...
    <div class="form-group">
        <spring:bind path="name">
            ...
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="code" class="form-control form-control-lg" id="code"
                            name="code"></form:input>
        ...
        <spring:bind path="name">
            ...
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="name" class="form-control form-control-lg" id="name"
        ...
        <spring:bind path="description">
            ...
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:textarea type="text" path="description" class="form-control form-control-lg" id="description"
        ...
        <spring:bind path="manufacturer">
            ...
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="manufacturer" class="form-control form-control-lg" id="manufacturer"
                            name="manufacturer"></form:input>
        ...
        <spring:bind path="price">
            ...
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="number" path="price" class="form-control form-control-lg" id="price"
        ...
        <spring:bind path="image">
            ...
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="file" multiple="multiple" path="image" class="form-control form-control-lg"
                            placeholder="Image"></form:input>
                <form:errors path="image"></form:errors>
            </div>
        </spring:bind>
    </div>
    <br>
    <button type="submit" class="btn btn-default"><h4>Оновити</h4></button>
